    ...
    <div className="page">
      <header className="cabecalho-pagina">
        ...
        <p className="subtitulo">
          É a única parte da prova com critério público e fechado: cinco competências, de 0 a
          200 pontos cada. Por isso é onde cada minuto de estudo rende mais.
        </p>
      </header>
      ...
      <section className="secao" aria-labelledby="producoes">
        ...
        {producoes.length === 0 ? (
          ...
          <ul className={s.historico}>
            {producoes.map((p, i) => {
              const total = p.autoavaliacao.c1 + p.autoavaliacao.c2 + p.autoavaliacao.c3 + p.autoavaliacao.c4 + p.autoavaliacao.c5;
              return (
